    ...
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="max-w-6xl mx-auto px-2 sm:px-4 lg:px-8">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-gray-600 text-base">Manage your platform and monitor activity</p>
        </div>
        {/* Navigation Tabs */}
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-6 flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-xs font-medium text-gray-600">Mess Plans</p>
                      <p className="text-xl font-bold text-gray-900">{stats.totalMessPlans}</p>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg shadow-sm p-6 flex items-center">
